...
<body class="bg-[#fafafa]">
  ...
  <div class="overflow-hidden justify-end bg-white sm:rounded-xl relative w-4/6 m-auto mb-14 mt-6 shadow-lg">
    ...
    <div class="border-t border-gray-200">
      <dl>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          <input class=" text-sm text-gray-900 sm:col-span-1 sm:mt-0p-2 w-full h-8 rounded-lg border-t border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#6C8D6C] focus:border-transparent" type="text" name="username">
        </div>
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Email</dt>
          <input class=" text-sm text-gray-900 sm:col-span-1 sm:mt-0p-2 w-full h-8 rounded-lg border-t border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#6C8D6C] focus:border-transparent" type="text" name="alamat">
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Phone Number</dt>
          <input class="text-sm text-gray-900 sm:col-span-1 sm:mt-0p-2 w-full h-8 rounded-lg border-t border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#6C8D6C] focus:border-transparent" type="text" name="tanggal_lahir">
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt class="text-sm font-medium text-gray-500">Address</dt>
            <input class=" text-sm text-gray-900 sm:col-span-1 sm:mt-0p-2 w-full h-8 rounded-lg border-t border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#6C8D6C] focus:border-transparent" type="text" name="email">
          </div>
